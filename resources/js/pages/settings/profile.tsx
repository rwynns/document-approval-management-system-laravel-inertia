                                        ...
                                        <div className="space-y-2">
                                            ...
                                            {showPinFields && (
                                                <div className="space-y-3">
                                                    ...
                                                    <Input type="password" name="pin_confirmation" placeholder="Konfirmasi PIN baru" maxLength={6} />
                                                </div>
                                            )}
                ...
                <Card>
                    <CardContent className="p-6">
                        <div className="mb-6">
                            ...
                            <p className="text-sm text-muted-foreground">Kelola tanda tangan digital Anda untuk proses approval dokumen</p>
                        </div>
                        <SignatureManager />
                    </CardContent>
                </Card>
