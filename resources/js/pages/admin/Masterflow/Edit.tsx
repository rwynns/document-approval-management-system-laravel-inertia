        ...
        <AppLayout>
            ...
            <div className="flex-1 space-y-4 p-4 pt-6 md:p-8">
                <div className="flex items-center justify-between space-y-2">
                    <div>
                        <h2 className="text-3xl font-bold tracking-tight">Edit Masterflow</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Perbarui informasi dasar masterflow.</CardDescription>
                        </CardHeader>
                    ...
                    <Card>
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <CardDescription>Perbarui urutan langkah approval yang diperlukan.</CardDescription>
                                </div>
                        ...
                        <CardContent className="space-y-4">
                            {formData.steps.map((step, index) => (
                                <div key={step.id || index} className="space-y-4 rounded-lg border p-4">
                                    <div className="flex items-center justify-between">
